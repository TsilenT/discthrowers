...
export function App() {
  ...
  // Join an online game. Waits for the first remote snapshot before mounting GameView.
  ...
  if (store) return <GameProvider store={store}><GameView theme={theme} /></GameProvider>;
